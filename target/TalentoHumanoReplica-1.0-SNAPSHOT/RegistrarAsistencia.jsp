...
<html>
    ...
    <body>
        <div class="d-flex">
            <div class="col-sm-4">
                <div class="card">
                    <form action="Controlador?menu=RegistrarAsistencia"method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm">
                                    <button type="submit" name="accion" value="Agregar" class="btn btn-outline-info"><i class="icon ion-md-person mr-1"></i>Agregar asistencia</button>
                                </div>
                            </div>
                        </div>
                    </form>
