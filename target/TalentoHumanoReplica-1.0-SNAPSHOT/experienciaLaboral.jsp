...
<html>
    ...
    <body>
        <div class="container mt-4">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="Controlador?menu=experienciaLaboral" method="POST">
                        <div class="row">
                            <!-- Columna izquierda -->
                            <div class="col-md-6">
                                <!-- Nombre -->
                                <div class="form-group row">
                                    <label for="txtApellidos" class="col-sm-5 col-form-label">Institucion:</label>
                                    <div class="col-sm-7">
                                ...
                                <!-- Nombre Institucion -->
                                <div class="form-group row">
                                    <label for="txtNombres" class="col-sm-5 col-form-label">Nombre Institucion:</label>
                                    <div class="col-sm-7">
                                ...
                                <!-- Departamento Area -->
                                <div class="form-group row">
                                    <label for="txtTel" class="col-sm-5 col-form-label">Departamento Area:</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label for="txtCel" class="col-sm-5 col-form-label">Denominacion del Puesto:</label>
                                    <div class="col-sm-7">
                                        <input type="text" value="${producto.getStock()}" name="txtCel" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <!-- Fecha Ingreso -->
                                <div class="form-group row">
                                    <label for="txtFechaIngreso" class="col-sm-5 col-form-label">Fecha Ingreso:</label>
                                    <div class="col-sm-7">
                                        <input type="date" value="${producto.getStock()}" name="txtFechaIngreso" class="form-control form-control-sm">
                                    </div>
                                </div>

                                <!-- Fecha Salida -->
                                <div class="form-group row">
                                    <label for="txtFechaSalida" class="col-sm-5 col-form-label">Fecha Salida:</label>
                                    <div class="col-sm-7">
                                        <input type="date" value="${producto.getStock()}" name="txtFechaSalida" class="form-control form-control-sm">
                                    </div>
                                </div>

                                <!-- Modalidad -->
                                <div class="form-group row">
                                    <label for="txtModalidad" class="col-sm-5 col-form-label">Modalidad:</label>
                                    <div class="col-sm-7">
                                ...
                                <!-- Motivo Salida -->
                                <div class="form-group row">
                                    <label for="txtMotivoSalida" class="col-sm-5 col-form-label">Motivo Salida:</label>
                                    <div class="col-sm-7">
