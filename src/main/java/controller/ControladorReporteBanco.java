 ...
 * @author Juan Bedoya
 */
public class ControladorReporteBanco extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            Logger.getLogger(ControladorReporteBanco.class.getName()).log(Level.SEVERE, null, ex);;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorReporteBanco</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorReporteBanco at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        ArrayList<CuentaBancaria> arrObj = new ArrayList();//creo un array de objetos
        ArrayList<CuentaBancaria> arrObjuno = new ArrayList();//creo un array de objetos
...
// Aquí continúa el resto de tu lógica, por ejemplo, las operaciones BUSQUEDA o FILTRAR  
        ...
        RequestDispatcher objretorno = request.getRequestDispatcher("ReporteBanco.jsp");
