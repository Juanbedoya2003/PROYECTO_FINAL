 ...
 * @author Juan Bedoya
 */
public class ControladorReporteFormacionAcademica extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            Logger.getLogger(ControladorReporteFormacionAcademica.class.getName()).log(Level.SEVERE, null, ex);;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorReporteFormacionAcademica</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorReporteFormacionAcademica at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<FormacionAcademica> arrObj = new ArrayList();//creo un array de objetos
        ArrayList<FormacionAcademica> arrObjuno = new ArrayList();//creo un array de objetos
...
// Aquí continúa el resto de tu lógica, por ejemplo, las operaciones BUSQUEDA o FILTRAR  
        ...
        RequestDispatcher objretorno = request.getRequestDispatcher("ReporteFormacionAcademica.jsp");
