...
<html>
    ...
    <body>
        <div class="d-flex">
            <div class="col-sm-4">
                <div class="card">
                    <form action="Controlador?menu=RegistrarPermiso"method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex"> 
                                <div class="col-sm-5 d-flex">
                                    ...
                                    <input type="text" name="codigopermiso2" placeholder="Cod" style="width: 40%; border: 1px solid #ccc; padding: 6px; box-sizing: border-box; outline: none;">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="nombresdocente" class="form-control" placeholder="nombres docente">
                                </div>
                            </div>

                            <div class="form-group"> 
                                <label><i class="icon ion-md-document mr-1"></i>Datos Asistencia:</label>
                            </div>
                            <div class="form-group d-flex"> 
                                <div class="col-sm-5 d-flex">
                                    <button type="text" name="codigopermiso1" style="width: 30%; border: 1px solid #ccc; padding: 6px; box-sizing: border-box; outline: none;"><i class="icon ion-md-barcode"></i></button>
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="nombremotivo"  placeholder="Motivo" class="form-control" style="text-align: center"> 
                                </div>
                            </div>
                            <div class="form-group d-flex"> 
                                <div class="col-sm-5 d-flex">
                                    <button type="text" name="observacionpermiso" class="form-control" placeholder="Observacion"></button>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="col-sm">
                                    <button type="submit" name="accion" value="Agregar" class="btn btn-outline-info"><i class="icon ion-md-person mr-1"></i>Agregar Permiso</button>
                                </div>
                            </div>
                        </div>
                    </form>
