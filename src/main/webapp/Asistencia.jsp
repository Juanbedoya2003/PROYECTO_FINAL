...
<html>
    <head>
        ...
        <title>ASISTENCIA CRUD</title>
    </head>
    <body>
        <div class="d-flex">
            <div class="card col-sm-14">
                <div class="card-body">
                    <form action="Controlador?menu=Asistencia" method="POST">
                        <div class="form-group">
                            <label>Fecha Asistencia:</label>
                            <input type="date" name="txtCedula"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Hora Entrada:</label>
                            <input type="time" name="txtNombres"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Hora Salida:</label>
                            <input type="time" name="txtApellidos"  class="form-control">
                        </div>
                        <div class="form-group">
